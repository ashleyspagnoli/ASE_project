...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Game History -> User-Manager:} Game History needs to connect to User Manager also to get a list of (updated) usernames from a list of user-ids to represent the leaderboard.
