...
\begin{itemize}
    ...
    \item \textbf{Academic Context:} As agreed with the Professor, keys are intentionally included since it's a project with educational purposes. In a real context, we wouldn't have published neither keys on the GitHub repository
